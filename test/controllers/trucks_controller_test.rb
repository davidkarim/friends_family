...
class TrucksControllerTest < ActionController::TestCase
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post :create, truck: { claimed: @truck.claimed, name: @truck.name, phone_number: @truck.phone_number, web_url: @truck.web_url }
    end
  ...
  test "should update truck" do
    patch :update, id: @truck, truck: { claimed: @truck.claimed, name: @truck.name, phone_number: @truck.phone_number, web_url: @truck.web_url }
    assert_redirected_to truck_path(assigns(:truck))
  end
